...
<body topmargin="0" leftmargin="0" bottommargin="0" bgcolor="#FF9966">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="425" bgcolor="#FF9966" valign="top"><div align="center">
      ...
      <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" onClick="javascript:openspgl()"><div align="center"><a href="#"><img id="d1" border="0"src="images/point1.gif" width="10" height="10">商品管理</a></div></td>
        </tr>
      </table>
      <table width="170" border="0" cellpadding="0" cellspacing="1" id="spgl" style="display:none">
        <tr>
          <td width="30" height="20" bgcolor="#FF9966"><div align="center"></div></td>
          <td width="137" height="20" bgcolor="#EEEEEE"><div align="center"><a href="addgoods.php" target="main">-添加商品</a></div></td>
        </tr>
		<tr>
          <td height="20" bgcolor="#FF9966"><div align="center"></div></td>
	  ...
	  <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" onClick="javascript:openyhgl()"><div align="center"><a href="#"><img id="d2" border="0"src="images/point1.gif" width="10" height="10">用户管理</a></div></td>
        </tr>
      </table>
      <table width="170" border="0" cellpadding="0" cellspacing="1" id="yhgl" style="display:none">
        ...
        <tr>
          <td height="20" bgcolor="#FF9966">&nbsp;</td>
          <td bgcolor="#EEEEEE"><div align="center">-<a href="changeadmin.php"  target="main">更改管理员信息</a></div></td>
        </tr>
      </table>
	    <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" onClick="javascript:openddgl()"><div align="center"><a href="#"><img id="d3" border="0"src="images/point1.gif" width="10" height="10">订单管理</a></div></td>
        </tr>
      </table>
      <table width="170" border="0" cellpadding="0" cellspacing="1" id="ddgl" style="display:none">
	   ...
	   <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" onClick="javascript:opengggl()"><div align="center"><a href="#"><img id="d4" border="0"src="images/point1.gif" width="10" height="10">信息管理</a></div></td>
        </tr>
      </table>
	  ...
	  <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" ><div align="center"><img  border="0"src="images/point1.gif" width="10" height="10"><a href="deleteallip.php">清空访客IP</a></div></td>
        </tr>
      </table>
	  <table width="170" height="20" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td bgcolor="#CCCCCC" ><div align="center"><img  border="0"src="images/point1.gif" width="10" height="10"><a href="../index.php" target="_parent">返回前台</a></div></td>
        </tr>
      </table>
	  <p>&nbsp;</p>
    </div></td>
