...
<table width="800" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	?></div></td>
    <td width="58"><div align="center"><a href="index.php">本站首页</a></div></td>
    ...
    <td width="67"><div align="center"><a href="showfenlei.php">商品分类</a></div></td>
    <td width="66"><div align="center"><a href="agreereg.php">用户注册</a></div></td>
    <td width="64"><div align="center"><a href="usercenter.php">用户中心</a></div></td>
    <td width="65"><div align="center"><a href="mydd.php">我的订单</a></div></td>
    <td width="82"><div align="center"><a href="gouwu1.php">我的购物车</a></div></td>
  </tr>
</table>
...
document.write(
    ...
    <td width="580" bgcolor="#E8E8E8"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;请输入产品名称：&nbsp;
          ...
          &nbsp;
          <input type="button" value="高级查找" class="buttoncss" onClick="javascript:window.location='highfind.php';">
      </div></td>
  </tr>
  </form>
</table>
