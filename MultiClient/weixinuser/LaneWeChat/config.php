 ...
 */
define("WECHAT_URL", 'http://115.29.235.211/weixinuser/LaneWeChat/wechat.php');
define('WECHAT_TOKEN', 'weixin');
define('ENCODING_AES_KEY', "8Lf3v4lCT1GOvj0YUAZRpL2cbnD4RQdDz70AjLsTPeL");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wx6ef2d0f9f1722166');
define("WECHAT_APPSECRET", 'da27acd7a2448c579da8f6ebcfcf3bb7');
